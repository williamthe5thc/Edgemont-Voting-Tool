      ...
      <div className="max-w-xl w-full px-6 text-center">
        ...
        <div className="relative w-96 h-96 mx-auto mb-8">
          ...
          >
            ...
            <path 
              fill="#FFFFFF" 
              d="M147.93,430.11c4.54,12.01,14.41,3.25,18.17-4.82,4.03-8.65,6.19-18.04,6.88-27.51.01-1.54.05-3.04.1-4.46-9.43-.24-18.87-.27-28.31-.2.15,12.34-1.21,25.45,3.15,36.99Z"
            />
