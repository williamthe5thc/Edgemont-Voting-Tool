      ...
      <div className="max-w-xl w-full px-6 text-center">
        ...
        <div className="relative w-96 h-96 mx-auto mb-8">
          ...
          >
            ...
            <path 
              fill="#FFFFFF" 
              d="M300,200 C300,290 240,350 200,350 C160,350 100,290 100,200 C100,110 160,50 200,50 C240,50 300,110 300,200 Z"
            />
            ...
            <path 
              ...
              stroke="black" 
              strokeWidth="3" 
              d="M160,120 C180,100 220,100 240,120"
            />
            <path 
              fill="none" 
              stroke="black" 
              strokeWidth="3" 
              d="M160,280 C180,300 220,300 240,280"
            />
            ...
            <g transform="translate(120,100) scale(0.5)">
              <path 
                fill="black" 
                d="M0,0 C20,-20 40,-20 60,0 C40,20 20,20 0,0 Z"
              />
            </g>
