            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 459.99 512">
                 <defs>
                    ...
                    <mask id="filling-mask">
                        <rect x="0" y="0" width="460" height="512" fill="black"/>
                        <rect class="mask-rect filling-animation" x="0" y="512" width="460" height="512" fill="white"/>

                    </mask>
                </defs>
                
                <g id="Generative_Object" data-name="Generative Object" mask="url(#filling-mask)">
    ...
    updateProgress() {
        if (this.progress < 100) {
            ...
            if (maskRect) {
                ...
                // Changed to fill from bottom up by adjusting the transform instead of y position
                const scaleY = this.progress / 100;
                maskRect.style.transform = `scaleY(${scaleY})`;
            }
        } else {
